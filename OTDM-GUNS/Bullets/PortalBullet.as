...
{
	if (this !is null && getNet().isServer())
	{
		u32 tiimi = this.get_u32("tiimi");
		CBlob@ portal = server_CreateBlob("portal", tiimi, this.getPosition());
		if (portal !is null)
		{
			portal.server_setTeamNum(this.getTeamNum());
			portal.set_u32("tiimi", tiimi);
			portal.getSprite().setRenderStyle(RenderStyle::light);
