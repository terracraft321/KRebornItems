...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$lantern on$", "RLantern.png", Vec2f(8, 8), 0);
	AddIconToken("$lantern off$", "RLantern.png", Vec2f(8, 8), 3);

	this.Tag("dont deactivate");
	this.Tag("fire source");
	this.SetLightColor(SColor(255, XORRandom(255), XORRandom(255), XORRandom(255)));
