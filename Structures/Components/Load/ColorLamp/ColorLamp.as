...
void onInit(CBlob@ this)
{
	...
	{
		this.SetLightColor(SColor(150, 60, 0, 255));
	}

	if (this.getTeamNum() < 0)
	{
		this.SetLightColor(SColor(120, 255, 150, 255));
	}
	...
	{
		this.SetLightColor(SColor(255, 225, 225, 255));
		this.SetLightRadius(355.0f);
	}
}
...
void onSetStatic(CBlob@ this, const bool isStatic)
{
	...
	if(sprite !is null)
	{
		...
		CSpriteLayer@ layer = sprite.addSpriteLayer("background", "ColorLamp.png", 16, 16);
