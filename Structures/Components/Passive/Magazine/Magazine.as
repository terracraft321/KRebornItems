...
void onSetStatic(CBlob@ this, const bool isStatic)
{
	...
	if (this.hasTag("infinite"))
		sprite.SetFrameIndex(this.hasTag("infinite")?2:0);
}
...
{
	this.getSprite().SetFrameIndex(this.hasTag("infinite")?3:1);
}

void onRemoveFromInventory(CBlob@ this, CBlob@ blob)
{
	this.getSprite().SetFrameIndex(this.hasTag("infinite")?2:0);
}
